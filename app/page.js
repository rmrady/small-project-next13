  ...
  return (
    <main className=" border-t border-gray-400 px-10">
      ...
      <div className="bg-white p-6 mt-7">
        ...
        <p className="className="text-gray-500 >Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown</p>
      </div>
      <div className="bg-white p-6 mt-7">
        <h3 className="text-[19px] font-bold pb-6">New webside livel</h3>
        <p className="className="text-gray-500 >Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero's De Finibus Bonorum et Malorum for use</p>
      </div>
